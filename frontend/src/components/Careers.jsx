...
const Careers = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8088/auth/jobs")
      .then((res) => {
  ...
  useEffect(() => {
    const filteredCareer = jobs.filter(
      (career) =>
                  ...
                  <div className="card job-list" key={index}>
                    <div className="card-body">
                      <div className="row  align-items-center justify-content-center text-center h-100">
                        <div className="">
                          <h3>
                            <b className="filter-txt">{j.title}</b>
                          </h3>
                          <div>
                            <span className="filter-txt h3 mr-5">
                              <small>
                                <b>
                                  <FaBuilding /> {j.company}
                                </b>
                              </small>
                            </span>
                            <span className="filter-txt h3">
                              <small>
                                <b>
                                  <FaMapMarker />
                                  {j.location}
                          ...
                          <p
                            ...
                            className="truncate filter-txt h4"
                          ></p>
                          <br />
                          <hr
                            className="divider"
