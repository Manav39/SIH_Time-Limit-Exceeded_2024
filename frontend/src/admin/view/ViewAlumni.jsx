...
const ViewAlumni = () => {
  ...
  const handleStatus = (num) => {
    console.log(num);
    axios
      .put("http://localhost:8088/auth/viewalumni", {
        status: num,
        id: alumni.id,
      })
      .then((res) => {
    ...
    <>
        ...
        <div className="col-lg-12">
          <div>
            <center>
              <div className="avatar">
                <img
                  src={`http://localhost:8088/${alumni.avatar}`}
                  className="vaimg"
                  alt="avatar"
                />
              </div>
          ...
          <div className="row">
            <div className="col-md-6">
              <p>
                Name: <b>{alumni.name}</b>
              </p>
              <p>
                Email: <b> {alumni.email} </b>
              </p>
              <p>
                Batch: <b> {alumni.batch} </b>
              </p>
              <p>
                Course: <b>{alumni.course} </b>
              </p>
            </div>
            <div className="col-md-6">
              <p>
                Gender: <b> {alumni.gender} </b>
              </p>
              <p>
                Connected To: <b> {alumni.connected_to} </b>
              </p>
              <p>
                Account Status:{" "}
                <b>
      ...
      <div className="modal-footer display">
        <div className="row">
          <div className="col-lg-12">
            <button
              onClick={() => navigate("/dashboard/alumnilist")}
