...
const AdminForum = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8088/auth/forums")
      .then((res) => {
  ...
  const delForum = (id) => {
    axios
      .delete(`http://localhost:8088/auth/forum/${id}`)
      .then((res) => {
            ...
            <div className="col-md-12">
              <div className="card">
                <div className="card-header">
                  ...
                  <span className="">
                    <button
                      onClick={() => navigate("/dashboard/forum/manage")}
