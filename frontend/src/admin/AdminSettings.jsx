            ...
            <div className="card-body">
              <form onSubmit={handleSubmit} id="manage-settings">
                ...
                <div className="form-group">
                  ...
                  <textarea
                    name="about_content"
                    className="form-control text-jqte"
                    value={system.about_content}
                    onChange={handleChange}
                  ></textarea>
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  <img
                    src={`http://localhost:8088/${system.cover_img}`}
                    alt="Cover"
                    id="cimg"
                  />
                </div>
                <center>
                  <button
                    type="submit"
                    className="btn btn-info btn-primary btn-block col-md-2"
                  >
                    Save
                  </button>
                </center>
